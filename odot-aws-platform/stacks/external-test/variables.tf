# variables.tf — Input variable declarations for the external-test stack.
#
...
variable "vpc_cidr" {
  description = "IPv4 CIDR block for the external-test VPC."
  type        = string
}
...
variable "cluster_name" {
  description = "Name of the ECS Fargate cluster (e.g., 'WebHosting-Test')."
  type        = string
}
