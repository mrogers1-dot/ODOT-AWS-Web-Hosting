# main.tf — Internal Dev stack composition.
#
# Wires together the five platform modules (networking, ecs-cluster, security,
# monitoring, oidc) for the internal-dev account-stage combination.
#
...
# ── Networking ────────────────────────────────────────────────────────────────
#
# Provisions the internal-dev VPC with private subnets only (no IGW, no public
